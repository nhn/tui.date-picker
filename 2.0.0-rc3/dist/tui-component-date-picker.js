...
/***/ function(module, exports, __webpack_require__) {
	...
	var TOUCH_CLICK_EV_TYPES = ['touchend', 'click'];
	 ...
	 *      @param {object} [option.timePicker] - {@link Timepicker} option
	 ...
	 *      @param {boolean} [option.inlineTimepicker] - Show inline timepicker
	 * @tutorial datepicker
	 * @example
	 *
	...
	var Datepicker = util.defineClass(/** @lends Datepicker.prototype */{
	    ...
	    _setEvents: function(option) {
	        setMouseTouchEvent(this._$container, TOUCH_CLICK_EV_TYPES, $.proxy(this._onClickDate, this), {
	            selector: '.' + CLASS_NAME_SELECTABLE,
	            namespace: this._id
	        });

	        setMouseTouchEvent(this._$container, TOUCH_CLICK_EV_TYPES, $.proxy(this._onClickCalendarTitle, this), {
	            selector: '.tui-calendar-title',
	            namespace: this._id
	        });

	        if (option.timepicker && !option.inlineTimepicker) {
	            setMouseTouchEvent(this._$container, TOUCH_CLICK_EV_TYPES, $.proxy(this._onClickSelectorButton, this), {
	    ...
	    addOpener: function(opener) {
	        ...
	        if (opener && util.inArray(opener, this._openers) < 0) {
	            ...
	            setMouseTouchEvent($opener, TOUCH_CLICK_EV_TYPES, $.proxy(this.toggle, this), {
	                namespace: this._id
	            });
	        }
	    },
	    ...
	    setDate: function(date) {
	        ...
	        shouldUpdate = (!prevDate || (newDate.getTime() !== prevDate.getTime()));
	        shouldUpdate = shouldUpdate && this.isSelectable(newDate);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timepicker = util.defineClass(/** @lends Timepicker.prototype */ {
	    ...
	    _renderTimeSelectors: function() {
	        ...
	        var BoxComponent = this._style.toLowerCase() === 'spinbox' ? Spinbox : Selectbox;

	        if (showMeridiem) {
	            hour = dateUtil.getMeridiemHour(hour);
	        }

	        this._hourSelector = new BoxComponent($hourElement, {
	            initialValue: hour,
	            items: showMeridiem ? dateUtil.getRangeArr(1, 12) : dateUtil.getRangeArr(0, 23)
	        });

	        this._minuteSelector = new BoxComponent($minuteElement, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatepickerInput = tui.util.defineClass(/** @lends DatepickerInput.prototype */{
	    ...
	    _setEvents: function() {
	        ...
	        setMouseTouchEvent(this._$input, ['touchend', 'click'], $.proxy(this.fire, this, 'click'), {
	            namespace: this._id
	        });
	    },
