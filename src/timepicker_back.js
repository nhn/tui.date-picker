...
//             defaultValue: hour,//opt.defaultHour,
//             min: (this._option.showMeridian) ? 1 : 0,//0,
//             max: (this._option.showMeridian) ? 12 : 23,//23,
//             step: opt.hourStep,
//             upBtnTag: upBtnTag,
...
//             //     console.log('2번');
//             // }
//         //     var prevHour = util.isNumber(this._hour) ?
//         //                     this._hour : this._option.defaultHour;
//         //     var isPM = (prevHour > 11);
//         //
//            console.log('=====================');
//         //     console.log(prevHour, tmpHour, isPM);
//         //
//         //
//         //
...
//         //
//         console.log(tmpHour);
//         console.log(':::::::'+!!(this._hour > 11 && this._hour < 24));
//         var isPM = (tui.util.isUndefined(this._isPM)) ? !!(tmpHour > 11) : this._isPM;
//         console.log(this._hour, hour);
//
//         // if (this._hour !== (hour + 12)) {
//         //     console.log('가틍ㅁ');
//         //     return;
//         // }
//
//             tmpHour = !util.isNumber(this._hour) ? this._option.defaultHour : hour;
//
//         //     console.log('>'+this._isPM);
//         //     console.log(':'+tmpHour);
//             tmpHour %= 12;
//
//             console.log('tmp' + tmpHour);
//
//
//
//             if (this._hour < 24) {
