...
!function(){"use strict";var e=ne.component.Calendar.Util,t=ne.util,i=t.inArray,n=/yyyy|yy|mm|m|dd|d/gi,s={yyyy:{expression:"(\\d{4}|\\d{2})",type:"year"},yy:{expression:"(\\d{4}|\\d{2})",type:"year"},y:{expression:"(\\d{4}|\\d{2})",type:"year"},mm:{expression:"(1[012]|0[1-9]|[1-9]\\b)",type:"month"},m:{expression:"(1[012]|0[1-9]|[1-9]\\b)",type:"month"},dd:{expression:"([12]\\d{1}|3[01]|0[1-9]|[1-9]\\b)",type:"date"},d:{expression:"([12]\\d{1}|3[01]|0[1-9]|[1-9]\\b)",type:"date"}},r=1970,a=3e3,o=[0,31,28,31,30,31,30,31,31,30,31,30,31];ne.component.DatePicker=ne.util.defineClass({init:function(e,t){this._calendar=t,this._$calendarElement=$(t.getElement()),this._element=e.element,this._dateForm=e.dateForm||"yyyy-mm-dd ",this._regExp=null,this._formOrder=[],this._date=null,this._defaultCentury=e.defaultCentury||"20",this._selectableClass=e.selectableClass||"selectableClass",this._startEdge=e.startDate,this._endEdge=e.endDate,this._withTimePicker=!!e.withTimePicker,this._timePicker=null,this._pos=null,this._openers=[],this._opened=!1,this._initializeDatePicker(e)},_initializeDatePicker:function(e){this._setDefaultDate(e.date),this._setDefaultPosition(e.pos),this._setRestrictiveDate(e.startDate,e.endDate),this._setOpeners(e.openers),this._element&&this._bindElementEvent(),this._withTimePicker&&this._initializeTimePicker(),this.setDateForm(),this.close()},_setDefaultDate:function(i){this._date=i?{year:t.isNumber(i.year)?i.year:r,month:t.isNumber(i.month)?i.month:1,date:t.isNumber(i.date)?i.date:1}:e.getDateHashTable(null)},_setDefaultPosition:function(e){var t=this._pos=e||{},i=this._getBoundingClientRect();t.left=t.left||i.left,t.top=t.top||i.bottom,t.zIndex=t.zIndex||9999},_setRestrictiveDate:function(t,i){var n=t||{year:r,month:1,date:1},s=i||{year:a,month:12,date:0};this._startEdge=e.getTime(n)-1,this._endEdge=e.getTime(s)+1},_setOpeners:function(e){var i=this;this.addOpener(this._element),t.forEach(e,function(e){i.addOpener(e)})},_initializeTimePicker:function(){var e=this;this._timePicker=new ne.component.TimePicker({showMeridian:!0}),this._timePicker.on("change",function(){e.setDate()}),this._$calendarElement.append(this._timePicker.$timePickerElement),this._timePicker.show()},_isValidYear:function(e){return t.isNumber(e)&&e>r&&a>e},_isValidMonth:function(e){return t.isNumber(e)&&e>0&&13>e},_isValidDate:function(e){var i,n,s=e.year,r=e.month,a=e.date;return this._isValidYear(s)&&this._isValidMonth(r)?(i=o[r],2===r&&s%4===0&&(s%100!==0||s%400===0)&&(i=29),n=!!(t.isNumber(a)&&a>0&&i>=a)):!1},_bindElementEvent:function(){$(this._element).on("click",ne.util.bind(this._onClickPicker,this)),$(this._element).on("keydown",ne.util.bind(this._onKeydownPicker,this))},_bindCloseLayerEvent:function(){var e=ne.util.bind(function(t){var i=t.target.className.indexOf(this._calendar._option.classPrefix)>-1,n=$.contains(this._$calendarElement[0],t.target);!this.isOpened()||i||n||this._isOpener(t.target)||($(document).off("click",e),this._onKeydownPicker(t),this.close())},this);$(document).on("click",e)},_isOpener:function(e){var i=!1;return t.forEach(this._openers,function(t){return e===t||$.contains(t,e)?(i=!0,!1):void 0}),i},_arrangeLayer:function(){var e=this._$calendarElement[0].style,t=this._pos;e.position="absolute",e.left=t.left+"px",e.top=t.top+"px",e.zIndex=t.zIndex},_getBoundingClientRect:function(e){var t,i,n=e||this._element;return t=n.getBoundingClientRect(),i=Math.ceil,{left:i(t.left),top:i(t.top),bottom:i(t.bottom),right:i(t.right)}},_bindOnClickCalendar:function(){ne.util.isFunction(this._binder)||(this._binder=ne.util.bind(this._onClickCalendar,this)),this._$calendarElement.find("."+this._selectableClass).on("click",this._binder)},_unbindOnClickCalendar:function(){this._$calendarElement.find("."+this._selectableClass).off("click")},_onClickPicker:function(){this.open()},_setDateFromString:function(e){var t=this._extractDate(e);t&&!this._isRestricted(t)?(this._timePicker&&this._timePicker.setTimeFromInputElement($(this._element)),this.setDate(t.year,t.month,t.date)):this.setDate()},_onKeydownPicker:function(e){e&&13===e.keyCode&&this._setDateFromString(this._element.value)},_onClickCalendar:function(t){var i,n,s,r=t.target,a=r.className,o=Number(r.innerText||r.textContent||r.nodeValue);o&&!isNaN(o)&&(i=this._calendar._getShownDate(),n=a.indexOf("prev-mon")>-1?-1:a.indexOf("next-mon")>-1?1:0,s=e.getRelativeDate(0,n,o-1,i),this.setDate(s.year,s.month,s.date))},_formed:function(){var e,t,i=this._date.year,s=this._date.month,r=this._date.date,a=this._dateForm;return s=10>s?"0"+s:s,r=10>r?"0"+r:r,e={yyyy:i,yy:String(i).substr(2,2),mm:s,m:Number(s),dd:r,d:Number(r)},t=a.replace(n,function(t){return e[t.toLowerCase()]||""})},_extractDate:function(e){var t=this._formOrder,i={},n=this._regExp;return n.lastIndex=0,n.test(e)?(i[t[0]]=Number(RegExp.$1),i[t[1]]=Number(RegExp.$2),i[t[2]]=Number(RegExp.$3),2===String(i.year).length&&(i.year=Number(this._defaultCentury+i.year)),i):!1},_isRestricted:function(t){var i=this._startEdge,n=this._endEdge,s=e.getTime(t);return!this._isValidDate(t)||i>s||s>n},_bindDrawEventForSelectableRange:function(){this._calendar.on("draw",ne.util.bind(function(e){this._isRestricted(e)||e.$dateContainer.addClass(this._selectableClass)},this))},_bindCalendarCustomEvent:function(){this._calendar.on("beforeDraw",ne.util.bind(function(){this._unbindOnClickCalendar()},this)),this._calendar.on("afterDraw",ne.util.bind(function(){this._bindOnClickCalendar()},this))},_unbindCalendarEvent:function(){this._calendar.off()},isOpened:function(){return this._opened},setXY:function(e,i){var n=this._pos;n.left=t.isNumber(e)?e:n.left,n.top=t.isNumber(i)?i:n.top,this._arrangeLayer()},setZIndex:function(e){t.isNumber(e)&&(this._pos.zIndex=e)},addOpener:function(e){i(e,this._openers)<0&&(this._openers.push(e),$(e).on("click",t.bind(this._onClickPicker,this)))},removeOpener:function(e){var t=i(e,this._openers);t>-1&&($(this._openers[t]).off("click"),this._openers.splice(t,1))},open:function(){this.isOpened()||(this._arrangeLayer(),this._bindDrawEventForSelectableRange(),this._bindCloseLayerEvent(),this._bindCalendarCustomEvent(),this._calendar.draw(this._date.year,this._date.month,!1),this._$calendarElement.show(),this._opened=!0)},close:function(){this._setDateFromString(this._element.value),this._unbindOnClickCalendar(),this._unbindCalendarEvent(),this._$calendarElement.hide(),this._opened=!1},getDateObject:function(){return t.extend({},this._date)},getYear:function(){return this._date.year},getMonth:function(){return this._date.month},getDayInMonth:function(){return this._date.date},setDate:function(e,i,n){var s,r=this._date,a={};a.year=e||r.year,a.month=i||r.month,a.date=n||r.date,this._isRestricted(a)||t.extend(r,a),this._element&&(s=this._formed(),this._withTimePicker&&(s+=this._timePicker.getTime()),this._element.value=s),this._calendar.draw(r.year,r.month,!1)},setDateForm:function(e){var t="^",i=this._formOrder,r=0;this._dateForm=e||this._dateForm,this._dateForm.replace(n,function(e){var n=e.toLowerCase();t+=s[n].expression+"(?:[\\D\\s]*)",i[r]=s[n].type,r+=1}),this._regExp=new RegExp(t,"gi"),this.setDate()},getTimePicker:function(){return this._timePicker}})}();
