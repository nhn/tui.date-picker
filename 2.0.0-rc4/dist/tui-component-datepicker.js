...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 *   var picker1 = new tui.component.Datepicker('#datepicker-container2, {
	 *       showAlways: true
	 *   });
	 *
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Calendar = util.defineClass(/** @lends Calendar.prototype */ {
	    ...
	    _render: function() {
	        ...
	        this._$element.removeClass(['tui-calendar-month-type', 'tui-calendar-year-type'].join(' '));

	        switch (type) {
	            case TYPE_MONTH:
	                this._$element.addClass([CLASS_NAME_CALENDAR_MONTH, 'tui-calendar-month-type'].join(' '));
	                break;
	            case TYPE_YEAR:
	                this._$element.addClass([CLASS_NAME_CALENDAR_YEAR, 'tui-calendar-year-type'].join(' '));
	                break;
	            default: break;
	        }
	    },
